...
$page_titles = [
    ...
    'gestao_unidades.php' => 'GestÃ£o de Unidades',
    'gestao_variacoes.php' => 'Gestão de Variações'
];
        ...
        <div class="admin-nav">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    ...
                    <!-- GestÃ£o de Unidades -->
                    <a href="gestao_unidades.php" class="nav-link <?php echo $current_page === 'gestao_unidades.php' ? 'active' : ''; ?>">
                        <i class="nav-icon fas fa-balance-scale"></i>
                        <span class="nav-text">GestÃ£o de Unidades</span>
                    </a>
                    
                    <!-- GestÃ£o de Variações -->
                    <a href="gestao_variacoes.php" class="nav-link <?php echo $current_page === 'gestao_variacoes.php' ? 'active' : ''; ?>">
                        <i class="nav-icon fas fa-layer-group"></i>
                        <span class="nav-text">GestÃ£o de Variações</span>
                    </a>
